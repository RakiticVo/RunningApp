...
class TrackingService: LifecycleService() {
    ...
    private fun updateNotificationTrackingState(isTracking: Boolean){
        ...
        val pendingIntent = if (isTracking) {
            ...
            PendingIntent.getService(this, 1, pauseIntent, PendingIntent.FLAG_MUTABLE or FLAG_UPDATE_CURRENT)
        }else{
            val resumeIntent = Intent(this, TrackingService::class.java).apply {
                action = ACTION_START_OR_RESUME_SERVICE
            }
            PendingIntent.getService(this, 2, resumeIntent, PendingIntent.FLAG_MUTABLE or FLAG_UPDATE_CURRENT)
        }
        ...
        timeRunInSeconds.observe(this) {
            if (!serviceKilled){
                val notification = currentNotificationBuilder
                    .setContentText(Tracking.getFormattedStopWatchTime(it * 1000L))
